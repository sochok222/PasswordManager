...
template <> constexpr inline auto WelcomeWindow::qt_create_metaobjectdata<qt_meta_tag_ZN13WelcomeWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "WelcomeWindow",
        "on_openDatabaseButton_clicked",
        "",
        "on_createDatabaseButton_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_openDatabaseButton_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_createDatabaseButton_clicked'
...
void WelcomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_openDatabaseButton_clicked(); break;
        case 1: _t->on_createDatabaseButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
